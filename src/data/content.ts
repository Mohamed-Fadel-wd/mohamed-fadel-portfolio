...
export const content = {
  ...
  ar: {
    ...
    hero: {
      eyebrow: "استراتيجي موارد بشرية · محلل بيانات · صانع", name: ["محمد", "فاضل"], mantra: "انضباط. نمو. أثر.",
    ...
    contact: {
      ...
      copyright: "© 2026 محمد فاضل", socials: ["لينكدإن", "إنستغرام", "إكس / تويتر"], top: "العودة إلى الأعلى",
    },
  },
} as const;
