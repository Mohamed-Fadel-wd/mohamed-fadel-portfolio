...
export default function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const over=(e:PointerEvent)=>{const t=(e.target as HTMLElement).closest("a,button,.project,.principle-card");ring.current?.classList.toggle("is-active",!!t);ring.current?.setAttribute("data-label",t?.classList.contains("project")?"VIEW":"")};
